...
1. Abra o terminal e conecte-se à sua instância local do **MongoDB**. Se você receber uma mensagem de erro com uma mensagem como ***Connection refused***, tente reiniciar sua instância através do menu lateral, no item `Conectando`.
...
⚠️ Como esse script **restaura a base de dados `dataFlights`**, se atente a salvar seu progresso nos arquivos de desafio!
